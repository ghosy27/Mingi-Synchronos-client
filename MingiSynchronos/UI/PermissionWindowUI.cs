...
public class PermissionWindowUI : WindowMediatorSubscriberBase
{
    ...
    public PermissionWindowUI(ILogger<PermissionWindowUI> logger, Pair pair, MingiMediator mediator, UiSharedService uiSharedService,
        ApiController apiController, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "Permissions for " + pair.UserData.AliasOrUID + "###MingiSynchronosPermissions" + pair.UserData.UID, performanceCollectorService)
    {
        Pair = pair;
    ...
    protected override void DrawInternal()
    {
        ...
        UiSharedService.AttachToolTip("This will set all permissions to your defined default permissions in the Mingi Settings");
