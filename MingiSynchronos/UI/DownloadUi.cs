...
public class DownloadUi : WindowMediatorSubscriberBase
{
    ...
    public DownloadUi(ILogger<DownloadUi> logger, DalamudUtilService dalamudUtilService, MingiConfigService configService,
        FileUploadManager fileTransferManager, MingiMediator mediator, UiSharedService uiShared, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "Mingi Synchronos Downloads", performanceCollectorService)
    {
