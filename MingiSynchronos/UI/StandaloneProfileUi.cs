...
public class StandaloneProfileUi : WindowMediatorSubscriberBase
{
    ...
    public StandaloneProfileUi(ILogger<StandaloneProfileUi> logger, MingiMediator mediator, UiSharedService uiBuilder,
        ServerConfigurationManager serverManager, MingiProfileManager MingiProfileManager, PairManager pairManager, Pair pair,
        PerformanceCollectorService performanceCollector)
        : base(logger, mediator, "Mingi Profile of " + pair.UserData.AliasOrUID + "##MingiSynchronosStandaloneProfileUI" + pair.UserData.AliasOrUID, performanceCollector)
    {
    ...
    protected override void DrawInternal()
    {
        try
        {
            ...
            var MingiProfile = _MingiProfileManager.GetMingiProfile(Pair.UserData);
            ...
            ImGui.SameLine();
            var descriptionTextSize = ImGui.CalcTextSize(MingiProfile.Description, wrapWidth: 256f);
            ...
            if (ImGui.BeginChildFrame(1000, childFrame))
            {
                ...
                ImGui.TextWrapped(MingiProfile.Description);
            }
            ImGui.EndChildFrame();
