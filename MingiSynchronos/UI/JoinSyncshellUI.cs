...
internal class JoinSyncshellUI : WindowMediatorSubscriberBase
{
    ...
    public JoinSyncshellUI(ILogger<JoinSyncshellUI> logger, MingiMediator mediator,
        UiSharedService uiSharedService, ApiController apiController, PerformanceCollectorService performanceCollectorService) 
        : base(logger, mediator, "Join existing Syncshell###MingiSynchronosJoinSyncshell", performanceCollectorService)
    {
