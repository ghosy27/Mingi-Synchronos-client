...
public class PopupHandler : WindowMediatorSubscriberBase
{
    ...
    public PopupHandler(ILogger<PopupHandler> logger, MingiMediator mediator, IEnumerable<IPopupHandler> popupHandlers,
        PerformanceCollectorService performanceCollectorService, UiSharedService uiSharedService)
        : base(logger, mediator, "MingiPopupHandler", performanceCollectorService)
    {
