...
public partial class IntroUi : WindowMediatorSubscriberBase
{
    ...
    protected override void DrawInternal()
    {
        ...
        {
            _uiShared.BigText("Welcome to Mingi Synchronos");
            ImGui.Separator();
            UiSharedService.TextWrapped("Mingi Synchronos is a plugin that will replicate your full current character state including all Penumbra mods to other paired Mingi Synchronos users. " +
                     ...
                     || !Directory.Exists(_configService.Current.CacheFolder)))
        {
            ...
            {
                UiSharedService.TextWrapped("To not unnecessary download files already present on your computer, Mingi Synchronos will have to scan your Penumbra mod directory. " +
                                     "Additionally, a local storage folder must be set where Mingi Synchronos will download other character files to. " +
                                     "Once the storage folder is set and the scan complete, this page will automatically forward to registration at a service.");
                UiSharedService.TextWrapped("Note: The initial scan, depending on the amount of mods you have, might take a while. Please wait until it is completed.");
                UiSharedService.ColorTextWrapped("Warning: once past this step you should not delete the FileCache.csv of Mingi Synchronos in the Plugin Configurations folder of Dalamud. " +
            ...
            if (!_dalamudUtilService.IsWine)
            {
                ...
                UiSharedService.ColorTextWrapped("The File Compactor can save a tremendeous amount of space on the hard disk for downloads through Mingi. It will incur a minor CPU penalty on download but can speed up " +
                    "loading of other characters. It is recommended to keep it enabled. You can change this setting later anytime in the Mingi settings.", ImGuiColors.DalamudYellow);
            }
        }
