...
public class CreateSyncshellUI : WindowMediatorSubscriberBase
{
    ...
    public CreateSyncshellUI(ILogger<CreateSyncshellUI> logger, MingiMediator MingiMediator, ApiController apiController, UiSharedService uiSharedService,
        PerformanceCollectorService performanceCollectorService)
        : base(logger, MingiMediator, "Create new Syncshell###MingiSynchronosCreateSyncshell", performanceCollectorService)
    {
    ...
    protected override void DrawInternal()
    {
        ...
        if (_lastCreatedGroup == null)
        {
            ...
            UiSharedService.TextWrapped("(Those preferred permissions can be changed anytime after Syncshell creation, your defaults can be changed anytime in the Mingi Settings)");
        }
        else
        {
