...
public class CompactUi : WindowMediatorSubscriberBase
{
    ...
    public CompactUi(ILogger<CompactUi> logger, UiSharedService uiShared, MingiConfigService configService, ApiController apiController, PairManager pairManager,
        ServerConfigurationManager serverManager, MingiMediator mediator, FileUploadManager fileTransferManager,
        TagHandler tagHandler, DrawEntityFactory drawEntityFactory, SelectTagForPairUi selectTagForPairUi, SelectPairForTagUi selectPairForTagUi,
        PerformanceCollectorService performanceCollectorService, IpcManager ipcManager)
        : base(logger, mediator, "###MingiSynchronosMainUI", performanceCollectorService)
    {
        ...
        TitleBarButtons = new()
        {
            new TitleBarButton()
            {
                ...
                {
                    ImGui.BeginTooltip();
                    ImGui.Text("Open Mingi Settings");
                    ImGui.EndTooltip();
                }
            },
            new TitleBarButton()
            {
                ...
                {
                    ImGui.BeginTooltip();
                    ImGui.Text("Open Mingi Event Viewer");
                    ImGui.EndTooltip();
                }
            }
        };
    ...
    protected override void DrawInternal()
    {
        ...
        if (!_ipcManager.Initialized)
        {
            ...
            UiSharedService.ColorTextWrapped($"One or more Plugins essential for Mingi operation are unavailable. Enable or update following plugins:", ImGuiColors.DalamudRed);
    ...
    private string GetServerError()
    {
        return _apiController.ServerState switch
        {
            ...
            ServerState.Disconnected => "You are currently disconnected from the Mingi Synchronos server.",
            ServerState.Disconnecting => "Disconnecting from the server",
            ServerState.Unauthorized => "Server Response: " + _apiController.AuthFailureMessage,
            ServerState.Offline => "Your selected Mingi Synchronos server is currently offline.",
            ...
            ServerState.NoAutoLogon => "This character has automatic login into Mingi disabled. Press the connect button to connect to Mingi.",
            _ => string.Empty
        };
    }
