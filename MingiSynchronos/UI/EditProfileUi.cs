...
public class EditProfileUi : WindowMediatorSubscriberBase
{
    ...
    public EditProfileUi(ILogger<EditProfileUi> logger, MingiMediator mediator,
        ApiController apiController, UiSharedService uiSharedService, FileDialogManager fileDialogManager,
        MingiProfileManager MingiProfileManager, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "Mingi Synchronos Edit Profile###MingiSynchronosEditProfileUI", performanceCollectorService)
    {
        IsOpen = false;
    ...
    protected override void DrawInternal()
    {
        ...
        var profile = _MingiProfileManager.GetMingiProfile(new UserData(_apiController.UID));
        ...
        ImGui.TextWrapped($"- All users that are paired and unpaused with you will be able to see your profile picture and description.{Environment.NewLine}" +
            ...
            $"- In case of valid reports from other users this can lead to disabling your profile forever or terminating your Mingi account indefinitely.{Environment.NewLine}" +
