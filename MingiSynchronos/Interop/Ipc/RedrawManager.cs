...
public class RedrawManager
{
    ...
    public RedrawManager(MingiMediator MingiMediator, DalamudUtilService dalamudUtil)
    {
    ...
    {
        _MingiMediator.Publish(new PenumbraStartRedrawMessage(handler.Address));
        ...
        finally
        {
            ...
            _MingiMediator.Publish(new PenumbraEndRedrawMessage(handler.Address));
        }
    }
