...
public sealed class IpcCallerHeels : IIpcCaller
{
    ...
    public IpcCallerHeels(ILogger<IpcCallerHeels> logger, IDalamudPluginInterface pi, DalamudUtilService dalamudUtil, MingiMediator MingiMediator)
    {
        _logger = logger;
    ...
    {
        _MingiMediator.Publish(new HeelsOffsetMessage());
    }
