...
public sealed class IpcCallerHonorific : IIpcCaller
{
    ...
    {
        _MingiMediator.Publish(new HonorificMessage(string.Empty));
    }
    ...
    private void OnHonorificLocalCharacterTitleChanged(string titleJson)
    {
        ...
        _MingiMediator.Publish(new HonorificMessage(titleData));
    }

    private void OnHonorificReady()
    {
        CheckAPI();
        _MingiMediator.Publish(new HonorificReadyMessage());
    }
}
