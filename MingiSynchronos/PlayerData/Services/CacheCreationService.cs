...
namespace MingiSynchronos.PlayerData.Services;
...
public sealed class CacheCreationService : DisposableMediatorSubscriberBase
{
    ...
    public CacheCreationService(ILogger<CacheCreationService> logger, MingiMediator mediator, GameObjectHandlerFactory gameObjectHandlerFactory,
