...
public sealed partial class CharaDataManager : DisposableMediatorSubscriberBase
{
    ...
    public CharaDataManager(ILogger<CharaDataManager> logger, ApiController apiController,
        ...
        MingiMediator MingiMediator, IpcManager ipcManager, DalamudUtilService dalamudUtilService,
        ...
        CharaDataCharacterHandler charaDataCharacterHandler, PairManager pairManager) : base(logger, MingiMediator)
    {
        ...
        MingiMediator.Subscribe<ConnectedMessage>(this, (msg) =>
        {
            _connectCts?.Cancel();
            _connectCts?.Dispose();
            _connectCts = new();
        ...
        MingiMediator.Subscribe<DisconnectedMessage>(this, (msg) =>
        {
            _ownCharaData.Clear();
            _metaInfoCache.Clear();
            _sharedWithYouData.Clear();
    ...
    public Task<(MingiCharaFileHeader LoadedFile, long ExpectedLength)>? LoadedMcdfHeader { get; private set; }
    ...
    public void SaveMingiCharaFile(string description, string filePath)
    {
