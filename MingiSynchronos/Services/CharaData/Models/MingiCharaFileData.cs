...
public record MingiCharaFileData
{
    ...
    public MingiCharaFileData() { }
    public MingiCharaFileData(FileCacheManager manager, string description, CharacterData dto)
    {
    ...
    public static MingiCharaFileData FromByteArray(byte[] data)
    {
        return JsonSerializer.Deserialize<MingiCharaFileData>(Encoding.UTF8.GetString(data))!;
    }
