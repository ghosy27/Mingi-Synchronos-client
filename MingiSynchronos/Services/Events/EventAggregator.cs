...
namespace MingiSynchronos.Services.Events;
...
public class EventAggregator : MediatorSubscriberBase, IHostedService
{
    ...
    public EventAggregator(string configDirectory, ILogger<EventAggregator> logger, MingiMediator MingiMediator) : base(logger, MingiMediator)
    {
