...
public sealed class MingiMediator : IHostedService
{
    ...
    {
        _logger.LogInformation("Starting MingiMediator");
        ...
        _logger.LogInformation("Started MingiMediator");
