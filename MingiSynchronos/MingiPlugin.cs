...
public class MingiPlugin : MediatorSubscriberBase, IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        Logger.LogInformation("Launching {name} {major}.{minor}.{build}", "Mingi Synchronos", version.Major, version.Minor, version.Build);
        Mediator.Publish(new EventMessage(new Services.Events.Event(nameof(MingiPlugin), Services.Events.EventSeverity.Informational,
            $"Starting Mingi Synchronos {version.Major}.{version.Minor}.{version.Build}")));
    ...
    public Task StopAsync(CancellationToken cancellationToken)
    {
        ...
        Logger.LogDebug("Halting MingiPlugin");
